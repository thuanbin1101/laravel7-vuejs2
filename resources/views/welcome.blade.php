                ...
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/employee/create">Add Employee
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/supplier/create">Add Supplier
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/category/create">Add Category
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/product/create">Add Product
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap4" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/expense/create">Add Expense
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/given-salary">Add Salary
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap6" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/stock">All Stock</router-link>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap7" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link class="collapse-item" to="/customer/create">Add Customer
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap8" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <router-link class="collapse-item" to="/stock">Report 1</router-link>
                                <router-link class="collapse-item" to="/stock">Report 2</router-link>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap9" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <router-link class="collapse-item" to="/order/all">All Order</router-link>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top"
                        v-show="$route.path === '/' || $route.path === '/register' ? false:true" style="display: none"
                        id="topbar">
                        ...
                        <footer class="sticky-footer bg-white">
                            <div class="container my-auto">
                                <div class="copyright text-center my-auto">
                                    ...
                                    <b><a href="https://indrijunanda.gitlab.io/" target="_blank">Ken Nguyen</a></b>
                                    </span>
                                </div>
                            </div>
                        </footer>
